...
with open(os.path.join(args.input_dir, 'charmap.pickle'), 'r', encoding='utf-8') as f:
    charmap = pickle.load(f)

with open(os.path.join(args.input_dir, 'inv_charmap.pickle'), 'r', encoding='utf-8') as f:
